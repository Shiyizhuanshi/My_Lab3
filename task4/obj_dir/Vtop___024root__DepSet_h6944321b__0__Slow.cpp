...
VL_ATTR_COLD void Vtop___024root___initial__TOP__0(Vtop___024root* vlSelf) {
    ...
    // Body
    vlSelf->top__DOT__one_delay__DOT__count = 0U;
}
...
VL_ATTR_COLD void Vtop___024root___ctor_var_reset(Vtop___024root* vlSelf) {
    ...
    vlSelf->top__DOT__second__DOT__count = VL_RAND_RESET_I(16);
    vlSelf->top__DOT__lfsr1__DOT__sreg = VL_RAND_RESET_I(7);
    vlSelf->top__DOT__one_delay__DOT__count = VL_RAND_RESET_I(4);
    vlSelf->top__DOT__one_delay__DOT__current_state = 0;
    vlSelf->top__DOT__one_delay__DOT__next_state = 0;
    vlSelf->__Vdly__top__DOT__lfsr1__DOT__sreg = VL_RAND_RESET_I(7);
