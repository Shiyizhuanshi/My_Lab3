...
VL_INLINE_OPT void Vtop___024root___sequent__TOP__0(Vtop___024root* vlSelf) {
    ...
    // Init
    SData/*15:0*/ __Vdly__top__DOT__one_second__DOT__count;
    // Body
    __Vdly__top__DOT__one_second__DOT__count = vlSelf->top__DOT__one_second__DOT__count;
    if (vlSelf->rst) {
        vlSelf->top__DOT__second = 0U;
        __Vdly__top__DOT__one_second__DOT__count = vlSelf->N;
    } else if (vlSelf->en) {
        if ((0U == (IData)(vlSelf->top__DOT__one_second__DOT__count))) {
            vlSelf->top__DOT__second = 1U;
            __Vdly__top__DOT__one_second__DOT__count 
                = vlSelf->N;
        } else {
            __Vdly__top__DOT__one_second__DOT__count 
                = (0xffffU & ((IData)(vlSelf->top__DOT__one_second__DOT__count) 
                              - (IData)(1U)));
            vlSelf->top__DOT__second = 0U;
        }
    }
    vlSelf->top__DOT__one_second__DOT__count = __Vdly__top__DOT__one_second__DOT__count;
}
...
VL_INLINE_OPT void Vtop___024root___sequent__TOP__1(Vtop___024root* vlSelf) {
    ...
    vlSelf->top__DOT__statemachine__DOT__current_state 
        = ((IData)(vlSelf->rst) ? 0U : vlSelf->top__DOT__statemachine__DOT__next_state);
