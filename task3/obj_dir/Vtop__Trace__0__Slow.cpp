...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+4,"N", false,-1, 15,0);
    tracep->declBus(c+5,"data_out", false,-1, 7,0);
    tracep->declBit(c+6,"second", false,-1);
...
VL_ATTR_COLD void Vtop___024root__trace_full_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+6,(vlSelf->top__DOT__second));
    bufp->fullSData(oldp+7,(vlSelf->top__DOT__one_second__DOT__count),16);
    bufp->fullIData(oldp+8,(vlSelf->top__DOT__statemachine__DOT__current_state),32);
    bufp->fullIData(oldp+9,(vlSelf->top__DOT__statemachine__DOT__next_state),32);
